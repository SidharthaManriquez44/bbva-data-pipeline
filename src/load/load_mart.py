...
class MartLoader:
    ...
    def load_bank_financial_year(self):
        self._run_mart(
            "mart.bank_financial_year",
            "insert_bank_financial_year.sql"
        )

    def load_bank_digital_year(self):
        self._run_mart(
            "mart.bank_digital_year",
            "insert_bank_digital_year.sql"
        )

    def load_bank_efficiency_year(self):
        self._run_mart(
            "mart.bank_efficiency_year",
            "insert_bank_efficiency_year.sql"
        )

    def load_bank_growth_year(self):
        self._run_mart(
            "mart.bank_growth_year",
            "insert_bank_growth_year.sql"
        )
