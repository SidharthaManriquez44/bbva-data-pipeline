...
@patch("src.load.bank_dimension.load_sql")
@patch("src.load.bank_dimension.get_engine")
def test_load_dim_bank_create_engine(mock_get_engine, mock_load_sql):
    mock_load_sql.return_value = "SELECT 1"
